...
opcode_entry opcode_table [512] = {
  ...
  /* 0x70 */	 IDEXW(r,jcc,1), IDEXW(r,jcc,1), IDEXW(r,jcc,1), IDEXW(r,jcc,1),
  /* 0x74 */	IDEXW(r,jcc,1), IDEXW(r,jcc,1), IDEXW(r,jcc,1), IDEXW(r,jcc,1),
  /* 0x78 */	 IDEXW(r,jcc,1), IDEXW(r,jcc,1),  IDEXW(r,jcc,1),  IDEXW(r,jcc,1),
  /* 0x7c */	IDEXW(r,jcc,1), IDEXW(r,jcc,1), IDEXW(r,jcc,1), IDEXW(r,jcc,1),
  ...
  /* 0x90 */	IDEX(a2r, xchg), IDEX(a2r, xchg), IDEX(a2r, xchg), IDEX(a2r, xchg),
  ...
  /* 0xe0 */	EMPTY, EMPTY, EMPTY, IDEXW(r,jcc,1),
  ...
  /* 0x80 */	IDEX(r,jcc),IDEX(r,jcc), IDEX(r,jcc), IDEX(r,jcc),
  /* 0x84 */	IDEX(r,jcc), IDEX(r,jcc), IDEX(r,jcc),  IDEX(r,jcc),
  /* 0x88 */	IDEX(r,jcc),IDEX(r,jcc), IDEX(r,jcc), IDEX(r,jcc),
  /* 0x8c */	IDEX(r,jcc), IDEX(r,jcc), IDEX(r,jcc),IDEX(r,jcc),
  ...
  /* 0xb4 */	EMPTY, EMPTY, IDEX(E2G,movzx),IDEXW(E2G,movzx,4),
